    ...
    <body id="body">
        ...
        <div id="contenedor">
            ...
            <input type="button" value="Pulse para ver todos nuestros servicios" onClick="window.location.href = '../servicios.php'">
                ...
                <h3>UTILIZAMOS EL MATERIAL Y REEMPLAZO MÁS ADECUADO PARA CADA CASO</h3>
                <div class="two-columns">
                    <p>La adaptación de lentes de contacto, en determinados casos específicos, 
                        es complicada y la Contactología se encarga de dar solución a estos casos, 
                        siendo necesario un estudio personalizado de sus condiciones refractivas, 
                        anatómicas y fisiológicas para poder elegir la lente de contacto que mejor se adapte a su ojo.
                        Sea cual sea el tipo, la adaptación de lentes de contacto debe de ser hecha 
                        por un optometrista, siendo necesario su seguimiento y control para evitar 
                        cualquier tipo de efecto adverso y poder garantizar una óptima visión y salud ocular.
                        <img class='foto_prensentacion' src="../../imagenes/aplicacion/servicios/lentillas.jpg" alt="foto_presentacion"/>

                        En Centro Optico Sánchez realizamos un estudio personalizado para la elección de la 
                        lente de contacto que mejor se adapte a las características, necesidades y 
                        estilo de vida de cada cliente y medimos la curvatura de la córnea, así como la 
                        cantidad y calidad de la lágrima entre otras cosas.
