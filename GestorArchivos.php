    ...
    if ($_FILES[$archivo]["type"] == "image/jpeg") {
        ...
        if ($_FILES[$archivo]["error"]) {
            ...
            if (file_exists("imagenes/" . $dir . "/" . $_FILES[$archivo]["name"])) {
                ...
                $consulta = sprintf("INSERT INTO galeriaimagenes (archivo, directorio) VALUES ('%s','%s')", $conexion->real_escape_string($_FILES[$archivo]["name"]), $conexion->real_escape_string($dir)
                );
